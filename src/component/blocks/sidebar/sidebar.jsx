      ...
      <div className="sidebar_content">
        <div className="profile">
          ...
          <div className="profile_header">
            ...
            <div className="profile_prof">блог front-end разработчика</div>
          </div>
          ...
          <ul className="social">
            ...
            <li className="social_item">
              <a
                ...
                target="_blank"
              >
                <img src="images/vk.svg" alt="Сергей Петухов vk" />
              </a>
            </li>
          </ul>
          ...
          <div className="profile_text">
            <p>
              Front-end разработчик. Созданием сайтов занимаюсь с 2021 года.
              Стэк: JavaScript, Sass, Gulp, Bootstrap, React.
            </p>
          </div>
        </div>
      </div>
