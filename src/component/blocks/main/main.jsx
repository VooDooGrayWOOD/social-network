...
import ArticlePost2 from "./article-post/article-post-2";
      ...
      <main className="main">
        <div className="container">
          <div className="stories">
            <div className="stories__item">
              ...
              <time className="stories__date" dateTime="2022-09-21 12:22">
                29.09.2022
              </time>
            </div>
            <div className="stories__item">
              ...
              <time className="stories__date" dateTime="2022-10-02 12:50">
                02.10.2022
              </time>
            </div>
            <div className="stories__item">
              ...
              <time className="stories__date" dateTime="2022-11-15 18:32">
                15.11.2022
              </time>
            </div>
            <div className="stories__item">
              ...
              <time className="stories__date" dateTime="2022-11-118 17:02">
                18.11.2022
              </time>
            </div>
          </div>
        ...
        <ul className="pagination">
          <li className="pagination__item">
            <a className="pagination__link" href="/some/valid/uri">
              &lt;
            </a>
          </li>
          <li className="pagination__item">
          ...
          <li className="pagination__item">
            <a className="pagination__link active" href="/some/valid/uri">
              2
            </a>
          </li>
          <li className="pagination__item">
